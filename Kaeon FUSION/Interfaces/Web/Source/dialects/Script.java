...
public class Script extends PhilosophersStone {
	
	public Object onCall(ArrayList<Object> packet) {
		
		if(!((String) packet.get(0)).equalsIgnoreCase("Build") ||
				!((String) packet.get(1)).equalsIgnoreCase("Script")) {
			
			return null;
		}
		
		legacy.web.utilities.script.Script builder = new legacy.web.utilities.script.Script();
