package legacy.web.utilities.page;
...
import legacy.web.utilities.style.Style;
...
public class PageBuilder extends FUSIONStone {
	...
	public void connectCommands() {
		...
		ONEPlus tags = new ONEPlus(IO.openAsString("Tags.op"));
		...
		ONEPlus attributes = new ONEPlus(IO.openAsString("Attributes.op"));
