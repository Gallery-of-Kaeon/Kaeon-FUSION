...
public class SortNumerical extends FUSIONUnit {
	
	public SortNumerical() {
		tags.add("Standard");
	}
	
	public boolean verify(Element element) {
		return element.content.equalsIgnoreCase("Sort Numerical");
	}
	...
	public Object process(Element element, ArrayList<Object> processed) {
		...
		return SortList.sortString("" + processed.get(0), true);
	}
}